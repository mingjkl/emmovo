...
int string_match(char *target_string, char *cmp_string, int start_pos, int cmp_len);
# 13 "main.c" 2
...
int main(void)
{
    char hex_string_to_uint32_t_input_str[8] = "112233AA";
    unsigned int hex_string_to_uint32_t_output_int;

    hex_string_to_uint32_t_output_int = hex_string_to_uint32_t(hex_string_to_uint32_t_input_str);


    printf("[FCN] hex_string_to_uint32_t endl");
    printf("[Input][Char*]: %s endl", hex_string_to_uint32_t_input_str);
    printf("[Output][int]: %d (hex: 0x%x) endl", hex_string_to_uint32_t_output_int, hex_string_to_uint32_t_output_int);
